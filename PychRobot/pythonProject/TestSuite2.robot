...
Test o logowaniu INFO
    [Documentation]      Logowanie na poziomie INFO  //Logging on at INFO level
    Log Info   wiadomość INFO

Test o logowaniu Warning
    [Documentation]       Logowanie na poziomi WARNING //Logging at WARNING level
    Log Warning    wiadomość WARN

Test z Repeat Keyword
    [Documentation]    Wykorzystywanie Repeat Keyword
    Repeat Keyword    3 times    Log Info    this log will be executed 3 times
...
Test z Run Keyword And Continue On Failure
       ...
       Repeat Keyword    5 times    Run Keyword And Continue On Failure  Log Info    Should be in green
...
Test Skip i Skip If
    ...
    Repeat Keyword    3 times    Log Info    this log will be 3 times
    [Teardown]        Log Info         this will be done even if there was a skip beforehand

Test z weryfikatorami Should
    [Documentation]  Wariacje z Sould... //Variations from Sould...
    Should Be Equal As Strings   ${EXPECTED}    robotframework
    Should Be Equal              ${EXPECTED}    robotframework    ignore_case=True    #ignoruje duze litery //ignores capital letters
...
Tworzenie list
       ...
       Log Many  @{lista}
       Log Info  ${lista}
       Log Info  ${lista}[0]     # wyswietli 'pierwszy' element //displays the 'first' element
       Log Info  ${lista}[0:2]   # wyswietli 'pierwszy' i 'drugi' element //displays the 'first' and 'second' elements
